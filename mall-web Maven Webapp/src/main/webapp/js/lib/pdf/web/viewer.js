...
// var DEFAULT_URL = '';
var file = getQueryStringByName('pdf');
var DEFAULT_URL = '/tools/pdfOutput?file=' + file;
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '/js/lib/pdf/web/images/';
  PDFJS.workerSrc = '/js/lib/pdf/build/pdf.worker.js';
  PDFJS.cMapUrl = '/js/lib/pdf/web/cmaps/';
...
var HOSTED_VIEWER_ORIGINS = ['null',
  'http://mozilla.github.io', 'https://mozilla.github.io', 'http://mozilla.github.io'];
